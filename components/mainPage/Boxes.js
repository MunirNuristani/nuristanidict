...
function Boxes() {
  ...
  return (
    <div className=" min-w-[calc(100vw-100px)]  !md:max-w-1/2 bg-[#306090] bg-solid rounded-xl pt-10 pb-20 mt-10 flex flex-col justify-center items-center mb-[350px] md:relative">
