...
function Header() {
  ...
  return (
    <header className={`sticky top-0 z-10`}>
      <nav
        className={`z-50 flex w-full wrap h-[120px] transition-all border-b-2 border-[#1B57A6] ease-in-out duration-1000 ${isShrunk&&"h-[80px]"} bg-[white] p-2 relative justify-center items-center`}
        dir="rtl"
      >
