...
function Footer() {
  ...
  const CSS = `hover:cursor-pointer relative text-center after:content-[''] after:absolute after:top-0 after:left-0 after:border-b-2 after:w-full after:h-full  flex shrink grow items-center  rounded-md after:hover:border-b-2 after:hover:border-[#121b33] after:duration-1000 after:ease-in-out  after:hover:ease-in-out after:hover:duration-500 after:opacity-0 after:hover:opacity-100 after:active:border-b-4 ${lan==="en"? "text-sm":""}`
  const firstColumn = [
    {
      name: homePage[lan],
      link: "/"
    ...
    },
    {
      ...
      link: "/landscapeImages"
    },
    {
      name: historicalImages[lan], 
      link: "/historicalImages"
    }
  ]
  ...
  return (
    <footer
      className={` ${
        lan === "en" ? "font-['Poppins'] " : ""
      } z-30 -bottom-1 flex flex-col justify-around mx-auto bg-[#F2F2F2] p-2 text-[#1B57A6] w-full border-t-2 border-[#1B57A6]`}
      dir={dir}
    >
      <div className=" mx-12 flex flex-row justify-between text-lg sm:hidden">
        <div className="flex flex-row items-center">
          ...
          <p
            dir={dir}
            className={`${lan === "en" ? "text-xl" : "text-3xl"} lg:hidden  ${
              dir === "rtl" ? "mr-4" : "ml-4"
            }`}
          >
            {mainH1[lan]}{" "}
        ...
        <ul
          className={`flex flex-col justify-center flex-wrap md:flex-col md:w-full ${
            dir === "rtl"
              ? "border-r-2 lg:pr-4 xl:pr-12"
              : "border-l-2 lg:pl-4 xl:pl-12"
          }  border-[#121b33] `}
        >
        ...
        <ul
          className={`flex flex-col justify-center flex-wrap  md:flex-col  lg:pr-4 xl:pr-12 md:w-full ${
            dir === "rtl"
              ? "border-r-2 lg:pr-4 xl:pr-12"
              : "border-l-2 lg:pl-4 xl:pl-12"
          } border-[#121b33]`}
        ...
        <div
          className={`flex flex-row-reverse justify-center items-center text-3xl ${
            dir === "rtl" ? "border-r-2 pr-6" : "border-l-2 pl-6"
          } border-[#121b33] `}
        >
          <a
