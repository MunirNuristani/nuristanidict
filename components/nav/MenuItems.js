...
function MenuItems() {
  ...
  return (
    ...
    <div className={`z-40 h-[calc(100vh-360px)] md:h-[calc(100vh-130px)] fixed top-20 right-0 w-1/4 sm:w-full border-2 bg-[#F2F2F2] ease-in-out duration-500 ${!showMenu && "-right-[100%]"} ${!shrinkHeader && "top-44 sm:top-32"} rounded-tl-lg`} dir='rtl'>
