...
function MenuItems() {
    ...
    const CSS = "relative text-center after:content-[''] after:absolute after:top-0 after:left-0 after:border-b-2 after:w-full after:h-full  py-2 flex shrink grow items-center  rounded-md after:hover:border-b-4 after:hover:border-[#1B57A6] after:duration-500 after:ease-in-out  after:hover:ease-in-out after:hover:duration-500 after:opacity-0 after:hover:opacity-100 after:active:border-b-4"

  return (
    
    <div className={`z-40 h-[calc(100vh-80px)] fixed top-20 right-0 w-1/3 border-2 bg-[#F2F2F2] ease-in-out duration-500 ${!showMenu && "-right-[100%]"} ${!shrinkHeader && "top-44"}`} dir='rtl'>
