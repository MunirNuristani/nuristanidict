...
برعلاوه عزیزان میتوانند از طریق ایمیل ادرس <a href="mailto:info@nuristani.info" >info@nuristani.info</a> نیز با بتماس شوند.
</p>
      <form className="flex flex-col">
        ...
        />
        <p className={`${validation.name? "text-red-600":"hidden"}`}>  نام تان بین ۳ الی ۲۵ حرف باشد</p>
      </div>
