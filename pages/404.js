...
function FourohFour() {
  ...
  return (
    <div className='flex justify-center items-center mx-2 sm:h-[calc(100vh-316px)] h-[calc(100vh-450px)] rounded-xl bg-white opacity-75 w-[900px] my-10'>
      <div dir={dir} className='text-4xl flex flex-col' >
        <span className="w-full text-center mx-auto"> {err} </span>
        <br/>
        <span className="border-t-2 pt-8 mr-3 pr-3 border-[#000000] text-center"> {msg404[lan]} </span>
      </div>
    </div>
  )
}
