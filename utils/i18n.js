export const phrases = {
  ...
  picInfo: {
    ...
    ps: "په دې وېب پاڼه کې د نورستان د ښکليو منظرو او د نورستان د خلکو عکسونه اېښودل شوي دي.",
    nr: " یووي سایت که نورستان به مجبیݩ به –ی داگول به بوسته بوسته چوېر تيي شته اوت"
  },
  dicInfo: {
    en: "On this site, three dictionaries, one named Nuristan Language Dictionary(Kalasha Ala), its translation in Pashto and Dari languages, Nuristan Dari Dictionary(Kalasha Ala), and Nuristan Culture(Kata language) have been made available to the readers.",
    prs: "در این سایت سه دکشنری, یکی به نام فرهنگ زبان نورستاني (کلښه الا) ترجمه آن با زبان های پشتو و دری, دوـ قاموس دری نورستانی(کلښه الا) و سه -  فرهنگ نورستانی(به زبان کته) به دسترس خواننده گان قرار داده شده است",
