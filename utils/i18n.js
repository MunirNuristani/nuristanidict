export const phrases = {
  ...
  alphabet: {
    en: "Nuristani Alphabet",
    prs: "الفبای زبان کلښه نورستان",
    ps: "دنورستان کلښه ژبې الفبا",
    nr: "نورستاني کلښه الا به باښ",
  },

  dictionary: {
    en: "Nuristani Dictionary",
    prs: "قاموس زبان دری - کلښه الا",
    ps: "د دری - کلښه ژبی قاموس",
  ...
  alphabetInfo: {
    en: "On this website, you can find the Alphabet of the Nuristani language along with its phonics and usage.",
    prs: "در این وب سایت می توانید الفبای زبان نورستانی را همراه با آوایی و کاربرد آن بیابید.",
    ps: "په دې ویب پاڼه کې تاسو کولی شئ د نورستاني الفبا او د هغې د فونیکونو او کارونې په اړه معلومات ترلاسه کړئ.",
    nr: "",
  },
  booksInfo: {
  ...
  articleInfo: {
    ...
    prs: "در این ویب سایت آن عده مقالات را یافته می توانید که در مورد تاریخ و فرهنگ نورستان یا کافرستان قدیم از سوی دانشمندان آگاه با مسایل نورستان نگاشته شده است.",
    ps: "په دې وېب پاڼه کې د نورستان د تاریخ او کلتور په اړه هغه مقالې موندلی شئ چې د نورستان د مسلو په اړه  پوهانو لخوا لیکل شوي دي..",
  ...
  dicInfo: {
    ...
    prs: "در این ویب سایت سه دکشنری, یکی به نام فرهنگ زبان نورستاني (کلښه الا) ترجمه آن با زبان های پشتو و دری, دوـ قاموس دری نورستانی(کلښه الا) و سه -  فرهنگ نورستانی(به زبان کته) به دسترس خواننده گان قرار داده شده است",
    ps: "په دې وېب پاڼه کې درې قاموسونه چې يو يې د نورستاني ژبې (کلښه الا)  قاموس چی په پښتو او دري ژبو ژباړه ده، دوهم یې  دري – نورستانی کلښه الا قاموس،  او دریم یې په کته ژبه نورستانی فرهنگ لوستونکو ته وړاندې شوي دي.",
  ...
  historicalImagesInfo: {
    ...
    prs: "در این وب سایت مجموعه بزرگی از تصاویر تاریخی نورستان را داریم.",
    ps: "په دې ویب پاڼه کې موږ د نورستان د تاریخي انځورونو یوه لویه ټولګه لرو.",
    nr: "",
  },
  articleTitle: {
  ...
  landscapeImages: {
    en: "Landscape Images",
    prs: "تصاویر مناظر نورستان",
    ps: "د نورستان منظرې انځورونه",
